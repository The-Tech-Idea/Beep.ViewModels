...
{
    public partial class MySqlConnectionViewModel : BaseViewModel
    {
        [ObservableProperty]
        ...
        public MySqlConnectionViewModel(IDMEEditor dMEEditor, IAppManager visManager) : base(dMEEditor, visManager)
        {
            ...
            Filters.Add(new AppFilter { FieldName = "DatasourceType", FieldType = typeof(DataSourceType), FilterValue = DataSourceType.Mysql, Operator = "=" });
            DBWork.Get(Filters);
